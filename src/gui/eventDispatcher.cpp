...
template<typename Event>
void EventDispatcher<Event>::invoke(const Event& event) const {
...
template void EventDispatcher<MouseMoveEvent>::invoke(const MouseMoveEvent&) const;
...
template void EventDispatcher<MouseButtonEvent>::invoke(const MouseButtonEvent&) const;
