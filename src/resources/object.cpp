...
template<>
BuildingComponent& Object::createComponent<BuildingComponent>(const entt::entity& entity, entt::registry& registry, const BuildingComponent& component) {
    return registry.emplace<BuildingComponent>(entity, component.gridPosition, component.size);
}

template<>
LightComponent& Object::createComponent<LightComponent>(const entt::entity& entity, entt::registry& registry, const LightComponent& component) {
    return registry.emplace<LightComponent>(entity, component.direction, component.ambient, component.diffuse, component.specular);
}

template<>
MeshComponent& Object::createComponent<MeshComponent>(const entt::entity& entity, entt::registry& registry, const MeshComponent& component) {
    return registry.emplace<MeshComponent>(entity, component.mesh);
}

template<>
ParkingComponent& Object::createComponent<ParkingComponent>(const entt::entity& entity, entt::registry& registry, const ParkingComponent& component) {
    return registry.emplace<ParkingComponent>(entity, component.parkingSpots);
}
